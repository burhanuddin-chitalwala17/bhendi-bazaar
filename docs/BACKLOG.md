...
| [multi-vendor-marketplace](specs/multi-vendor-marketplace/) | Three audiences, three portals, and the data model a marketplace needs | 🚧 In progress — 7 of 10 subfeatures done (order-and-cart-lines PR-43/44); org-team deferred by decision |
