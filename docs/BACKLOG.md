...
| [multi-vendor-marketplace](specs/multi-vendor-marketplace/) | Three audiences, three portals, and the data model a marketplace needs | 🚧 In progress — 6 of 10 subfeatures done (category-tree PR-42); org-team deferred by decision |
