...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-br from-hero via-hero/90 to-scrim px-6 py-10 text-hero-foreground sm:px-10 sm:py-16">
      ...
      <div className="relative max-w-xl space-y-4">
        ...
        <p className="text-sm text-hero-foreground/80 sm:text-base">
