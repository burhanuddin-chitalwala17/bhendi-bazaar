    ...
    items: [
      {
        ...
        quantity: 1,
        price: 256000,
        thumbnail: "https://placehold.co/800x800/eab308/ffffff.png?text=Emerald+Necklace",
      },
    ],
    orgId: seedOrgs[1].id,
    fromPincode: seedOrgs[1].pickup.pincode,
    ...
    items: [
      {
        ...
        quantity: 1,
        price: 153000,
        thumbnail: "https://placehold.co/800x800/f59e0b/ffffff.png?text=Sandalwood+Amber",
      },
      {
        productId: "prod-9",
